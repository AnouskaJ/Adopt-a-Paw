    ...
    <div>
      <section className="menu" id="up">
        <div className="content">
          ...
          <div className="box">
            <div className="imgbx">
              <img src="https://cdn.britannica.com/80/29280-050-A3A13277/Beagles-pets.jpg" alt="Beagle Image" />
            </div>
            <div className="text">
              <h3>Cooper,Beagle</h3>
              <h5>Location:Chandigarh</h5>
              <h5>Contact:puppyadopt@yahoo.com</h5>
            </div>
          </div>
          <div className="box">
            <div className="imgbx">
          ...
          <div className="box">
            <div className="imgbx">
              <img src="https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcSBoK89oPXwd-GUvs4A04G7ioX984ldGTtkP4BQlsrn-VhjoGCbt6MTgoDKdC8N4r3B8XCZmj6IrQpGKrA" alt="Beagle Image" />
            </div>
            <div className="text">
              <h3>Rosie, Rosella</h3>
              <h5>Location: Rajasthan</h5>
              <h5>Contact:birdsofparadyes@gmail.com</h5>
            </div>
          </div>
          <div className="box">
            <div className="imgbx">
          ...
          <div className="box">
            <div className="imgbx">
              <img src="https://www.pawtracks.com/wp-content/uploads/sites/2/2022/10/gray-munchkin-cat-kitten.jpg?p=1" alt="Beagle Image" />
            </div>
            <div className="text">
              <h3>Coco, Munchkin Cat</h3>
              <h5>Location:New Delhi</h5>
              <h5>Contact:Catspaw@yahoo.com</h5>
            </div>
          </div>
          <div className="box">
            <div className="imgbx">
          ...
          <div className="box">
            ...
            <div className="text">
              ...
              <h5>Location:Bangalore</h5>
              <h5>Contact: HappyHome@gmail.com</h5>
            </div>
          </div>
          <div className="box">
            <div className="imgbx">
          ...
          <div className="box">
            <div className="imgbx">
              <img src="https://cdn.shopify.com/s/files/1/0424/4606/1723/files/Syrian-Hamster_grande.jpg?v=1594383125" alt="Beagle Image" />
            </div>
            <div className="text">
              <h3>Stuart, Syrian Hamster</h3>
              <h5>Location: New Delhi</h5>
              <h5>contact: adoptionJ@gmail.com</h5>
            </div>
          </div>
          <div className="box">
            <div className="imgbx">
